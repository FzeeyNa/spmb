...
$routes->get('/verifikator/updateRombelSMK', 'Verifikator::updateRombelSMK', ['filter' => 'auth']);
$routes->get('/verifikator/updateRombelSMA', 'Verifikator::updateRombelSMA', ['filter' => 'auth']);

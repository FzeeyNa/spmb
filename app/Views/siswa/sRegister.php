...
<head>
  ...
  <meta content="Daftar Sekolah Prestasi Prima Tahun 2025 / 2026" name="keywords">
    <title><?= $title; ?></title>
                    ...
                    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form id="form-register" action="<?= base_url('register/save') ?>" method="POST" class="needs-validation" novalidate="">
                                    <?= csrf_field(); ?>
                                    ...
                                    <input id="pass" type="text" class="form-control" name="pass" value="<?= $pass; ?>" hidden>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input id="asalSekolah" type="text" class="form-control" name="asalSekolah" placeholder="Asal Sekolah" required onkeyup="myFunction1()">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input id="first_name" type="text" class="form-control" name="tempatLahir" placeholder="Tempat Lahir">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input id="last_name" type="date" class="form-control" name="tglLahir">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-12 col-lg-6">
                                            ...
                                            <input id="hpOrtu" type="text" class="form-control" name="hpOrtu" placeholder="ex. 6283874766770" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" style="height: 100%;" rows="3" name="alamat" id="alamat" required></textarea>
                                            <div class="invalid-feedback">
                                                Mohon Alamat Diisi
                                            </div>
                                        ...
                                        <div class="form-group">
                                           <button class="btn btn-primary btn-lg d-block d-sm-inline-block w-100 w-sm-auto">
  Daftar Sekarang
</button>
              ...
              Don't have an account? <a href="auth-register.html">Create One</a>
                        ...
                        <p class="text-center"> <a href="<?= base_url('home/login') ?>" name="register" class="btn btn-info btn-md" tabindex="4">
...
<div class="modal fade" tabindex="-1" role="dialog" id="pengerjaan">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Maaf, untuk saat ini kami hanya melayani pendaftaran offline. Mengingat kuota sangat terbatas segera datang ke sekolah kami untuk melakukan registrasi.<br><br>
                Admin Prestasi Prima: +62 812 1962 4232</h5>
    ...
    <?php } ?>
     ...
     <?php if (session()->getFlashdata('msg')) { ?>
        <script>
            iziToast.error({
                title: 'Maaf, ',
                message: 'Mohon agar semua Data Diisi',
                position: 'topRight'
            });
        </script>
    <?php } ?>

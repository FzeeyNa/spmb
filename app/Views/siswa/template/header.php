...
<body>
    <div class="chating" style=" z-index: 99999; width: 50px; padding: 15px;  bottom:0; right:80px; position: fixed;">
        <a href="https://api.whatsapp.com/send?phone=+6282315388686&text=Hallo Sekolah Prestasi Prima" target="_blank">

            <span class="badge badge-success"><i class="fab fa-whatsapp"></i> Kontak Kami</span></a>
    </div>
    <div id="app">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, <?= session('nmPendaftar'); ?></div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?php $enkris = base64_encode($_SESSION['idPendaftar']);
                                        echo base_url('siswa/gantiPass') . '/' . $enkris ?>" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= base_url('siswa') ?>">Dashboard Siswa</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('siswa') ?>">DS</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php
                                    ...
                                    $enkri = base64_encode($_SESSION['idPendaftar']);
                                    if ($active == 'dashboard') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('siswa/dashboard') . '/' . $enkri; ?>"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
                        <li class="<?php if ($active == 'sformulir') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('siswa/formulir') ?>"><i class="fas fa-file-signature"></i> <span>Pembelian Formulir</span></a></li>

                        <?php if ($_SESSION['noFormulir'] != null) {

                        ?>
                            <li class="<?php
                                        $enkri = base64_encode($_SESSION['noFormulir']);

                                        if ($active == 'tes') {
                                            echo 'active';
                                        } ?>"><a class="nav-link" href="<?= base_url('siswa/tes') . "/" . $enkri; ?>"><i class="fas fa-user-edit"></i> <span>Tes Potensi Akademik</span></a></li>


                            <li class="nav-item dropdown <?php if ($active == 'pointerSiswa' || $active == 'pointerOrtu') {
                                                                echo 'active';
                                                            } ?>">
                                <a href="#" class="nav-link has-dropdown"><i class="fas fa-clipboard-check"></i><span>Pointer Wawancara</span></a>
                                <ul class="dropdown-menu">
                                    <li class="<?php
                                                $enkris = base64_encode($_SESSION['idPendaftar']);
                                                if ($active == 'pointerSiswa') {
                                                    echo 'active';
                                                } ?>"><a class="nav-link" href="<?= base_url('siswa/pointerSiswa') . '/' . $enkris ?>">
                                            Calon Siswa <span class="badge badge-primary" style="margin-left: 80px;"></span>
                                        </a></li>

                                    <li class="<?php
                                                $enkris = base64_encode($_SESSION['idPendaftar']);
                                                if ($active == 'pointerOrtu') {
                                                    echo 'active';
                                                } ?>"><a class="nav-link" href="<?= base_url('siswa/pointerOrtu') . '/' . $enkris ?>">Orang Tua Siswa</a></li>
                                </ul>
                            </li>

                            <li class="<?php if ($active == 'daftarUlang') {
                                            echo 'active';
                                        } ?>"><a class="nav-link" href="<?= base_url('siswa/daftar-ulang') ?>"><i class="fas fa-address-card"></i> <span>Daftar Ulang</span></a></li>
                        ...
                        <li class="<?php if ($active == 'pengumuman') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('/siswa/pengumuman') ?>"><i class="fas fa-bullhorn"></i> <span>Pengumuman</span></a></li>

                        <li class="menu-header">Pengaturan</li>

                        <li class="<?php if ($active == 'gantiPass') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('siswa/gantiPass') . '/' . $enkris ?>"><i class="fas fa-user-cog"></i> <span>Ganti Password</span></a></li>

...
<div class="section-header">
    <h1>Konfirmasi Pembayaran Formulir</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="<?= base_url('verifikator') ?>">Beranda</a></div>
        <div class="breadcrumb-item"><a href="#">Verifikasi Pembayaran</a></div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($queryData as $row) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle"><?= $row['asalSekolah']; ?></td>
                                    ...
                                    <td class="align-middle">
                                        <div class="gallery ml-3">
                                            <div class="gallery-item" data-image="<?= base_url(); ?>/assets/assets/img/vformulir/<?= $row['gbrBuktiBayar'] ?>" data-title="Image 11"></div>
                                        </div>
                                    ...
                                    <td class="align-middle">
                                        <div class="gallery ml-3">
                                            <div class="gallery-item" data-image="<?= base_url(); ?>/assets/assets/img/vformulir/<?= $row['kwitansi'] ?>" data-title="Image 11"></div>
                                        </div>
                                    ...
                                    <td class="align-middle"> <span class="badge badge-<?php if (($row['status']) == "sudah formulir") {
                                                                                            ...
                                                                                            echo "warning";
                                                                                        } ?>"><?php if ($row['status'] == 'sudah formulir') {
                                                                                                    echo 'lunas';
                                                                                                } else {
                                                                                                    echo $row['status'];
                                                                                                } ?></span></td>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4>List Calon Siswa Belum Daftar Ulang</h4>
                  <div class="row justify-content-end mb-1 mr-1">
                 <a href="<?= base_url('verifikator/exportBelumDaftarUlang');?>"> <button class="btn btn-sm btn-success float-end mr-1" id="excel"><i class="fas fa-file-excel" data-toggle="tooltip" data-placement="top" title="Download Excel"></i> </button></a> <button class="btn btn-sm btn-primary float-end" id="refresh"><i class="fas fa-sync-alt" data-toggle="tooltip" data-placement="top" title="Refresh"></i> </button>
                </div>
                <div class="table-responsive">
                    ...
                    <div class="profile-widget-description">
                        ...
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" id="noFormulir_d" readonly>
                            </div>
                            <div class="form-group col-4">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editSMK">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="far fa-trash"></i>Konfirmasi Pembelian Formulir</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="card profile-widget card-primary">
                    <div class="profile-widget-header">
                        ...
                        <div class="profile-widget-items">
                             ...
                             <div class="profile-widget-item">
                                <div class="profile-widget-item-label" style="font-size: 14px;"><strong><span id="nmPendaftar_z"></span></strong></div>
                    ...
                    <div class="profile-widget-description">
                        <form action="<?= base_url('verifikator/editFormulir') ?>" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row">
                                ...
                                <input type="text" class="form-control" id="verifikator_e" name="verifikator" hidden>
                                ...
                                <div class="form-divider">
                                    ...
                                    <div class="form-group col-12">
                                        <label for="first_name">No Formulir</label>
                                        <input type="text" class="form-control" id="noFormulir_e" name="noFormulir" placeholder="ex. SMK0001" required>
                                        <?php if ($validasi->getError('noFormulir')) {
                                            echo " <div style='color:red'>" . $validasi->getError('noFormulir') . "</div>";
                                        } else { ?>
                                            ...
                                            <div style="color:red">
                                                Format No Formulir SMK0001 / SMA0001
                                            </div>
                                        <?php } ?>
                                    </div>
                                    <div class="form-group col-12">
 ...
 <input type="text" class="form-control" id="tglKonfirmasi_e" readonly hidden>
                                 
                                    
                                        
                                        <input type="text" class="form-control" id="tglVerifikasi_e" readonly hidden>
                              
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" style="color: white;" data-dismiss="modal">Batal</button>
...
<script>
    $(document).on('click', '.update', function(e) {
        ...
        $('#nmPendaftar_e').val(nmPendaftar);
           $('#nmPendaftar_z').text(nmPendaftar);
...
<script>
    <?php if (session()->getFlashdata('formulirEdit')) { ?>
        iziToast.success({
            title: 'Selamat!',
...
<script>
    <?php if ($validasi->hasError('kwitansi')) { ?>
        iziToast.error({
            title: 'Maaf!',
            message: 'Data Tidak Berhasil Disimpan karena format gambar tidak sesuai atau ukuran melebihi 1 Mb',
            position: 'bottomRight'
        });
    <?php } ?>
</script>
...
<script>
    <?php if ($validasi->hasError('noFormulir')) { ?>
        iziToast.error({
            title: 'Maaf!',
            message: 'No Formulir sudah terdaftar',
            position: 'bottomRight'
        });
    <?php } ?>
</script>

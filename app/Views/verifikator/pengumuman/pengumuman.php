    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="myForm" action="<?= base_url('verifikator/savePengumuman') ?>" class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($query as $row) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle" width="10%"> <a href="<?= base_url('verifikator/update') . "/" . $row['id']; ?>" class="btn btn-warning btn-sm update"><i class="fas fa-pen" data-toggle="tooltip" data-placement="top" title="Edit"></i></a> <a href="" data-href="<?= base_url('verifikator/delete') . "/" . $row['id'] ?>" c data-toggle="modal" data-target="#konfirmasi_hapus" class="btn btn-danger btn-sm"><i class="fas fa-trash" data-toggle="tooltip" data-placement="top" title="Hapus"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>

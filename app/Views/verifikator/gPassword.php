        ...
        <div class="col-12 col-lg-5">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form id="form-register" action="<?= base_url('verifikator/gPasswordEdit/') ?>" method="POST" class="needs-validation" novalidate="">
                        <?= csrf_field(); ?>
                        <input type="text" class="form-control" name="idUser" value="<?= session('idUser') ?>" hidden>

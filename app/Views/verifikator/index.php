...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["BC (<?= $bc; ?>)", "RPL (<?= $rpl; ?>)", "MM (<?= $mm; ?>)", "TKJ (<?= $tkj; ?>)"],
            datasets: [{
                label: 'Formulir',
                data: [<?= $bc; ?>, <?= $rpl; ?>, <?= $mm; ?>, <?= $tkj; ?>],
                borderWidth: 2,
...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["BC (<?= $daftarUlangBC; ?>)", "RPL (<?= $daftarUlangRPL; ?>)", "MM (<?= $daftarUlangMM; ?>)", "TKJ (<?= $daftarUlangTKJ; ?>)"],
            datasets: [{
                label: 'Daftar Ulang',
...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["IPA (<?= $daftarUlangIPA; ?>)", "IPS (<?= $daftarUlangIPS; ?>)"],
            datasets: [{
                label: 'Daftar Ulang',

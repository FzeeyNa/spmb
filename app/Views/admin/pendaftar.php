                        ...
                        <tbody>
                            ...
                            <?php foreach ($idPendaftar as $baris) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <span class="badge badge-<?php if ($baris['pre_student_id'] !== null) {
                                                                        echo 'success';
                                                                    } else
                                                                    {
                                                                        echo 'warning';
                                                                    }
                                                                    ?>"><?php if ($baris['pre_student_id'] !== null) {
                                                                        echo 'Ya';
                                                                    } else
                                                                    {
                                                                        echo 'Tidak';
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <a href="<?= base_url('pendaftar/syncIntegration') . "/" . $baris['idPendaftar'] ?>" class="btn btn-primary btn-sm" ><i class="fas fa-sync" data-toggle="tooltip" data-placement="top" title="Synkronisasi Data"></i> </a>
                                        <a href="<?= base_url('pendaftar/createFormulirInvoice') . "/" . $baris['idPendaftar'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-book fa-book" data-toggle="tooltip" data-placement="top" title="Generate Tagihan Formulir"></i> </a>
                                        
                                        <a href="<?= base_url('pendaftar/createReregistrationInvoice') . "/" . $baris['idPendaftar'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-file" data-toggle="tooltip" data-placement="top" title="Generate Tagihan Registrasi Ulang"></i> </a>

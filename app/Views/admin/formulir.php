...
<div class="modal fade" tabindex="-1" role="dialog" id="editSMK">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="far fa-trash"></i>Edit Calon Pendaftar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="card profile-widget card-primary">
                    ...
                    <div class="profile-widget-description">
                        <form action="<?= base_url('formulir/edit') ?>" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    <label for="first_name">ID Pendaftar</label>
                                    <input type="text" class="form-control" id="idPendaftar_e" name="idPendaftar" readonly>
                                </div>
                                <div class="form-group col-4">
                                    <label for="first_name">Nama Lengkap</label>
                                ...
                                <div class="form-group col-4">
                                    <label for="last_name">Tanggal Lahir</label>
                                    <input type="text" class="form-control" id="tglLahir_e" name="tglLahir">
                                </div>
                                ...
                                <div class="form-group col-4">
                                    <label for="last_name">Tanggal Daftar</label>
                                    <input type="text" class="form-control" id="tglDaftar_e" readonly>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    <label for="last_name">Tanggal Verifikasi</label>
                                    <input type="text" class="form-control" id="tglVerifikasi_e" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-5">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="sudah formulir" name="status" id="lunas">

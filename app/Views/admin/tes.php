                        ...
                        <tbody>
                            ...
                            <?php foreach ($id as $row) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle" width="10%"> <a href="#" class="btn btn-warning btn-sm update" data-toggle="modal" data-target="#editTes" data-noFormulir="<?= $row['noFormulir'] ?>" data-idPendaftar="<?= $row['idPendaftar'] ?>" data-nmPendaftar="<?= $row['nmPendaftar'] ?>" data-sekolah="<?= $row['sekolah'] ?>" data-kdJurusan="<?= $row['kdJurusan'] ?>" data-idKartu="<?= $row['idKartu'] ?>" data-status="<?= $row['status'] ?>"><i class="fas fa-pen" data-toggle="tooltip" data-placement="top" title="Konfirmasi"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="myForm" action="<?= base_url('tes/edit') ?>" class="needs-validation" novalidate="" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>

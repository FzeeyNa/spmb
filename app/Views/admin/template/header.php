            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= base_url('admin') ?>">ADMIN PPDB</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('admin') ?>">DB</a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Menu Utama</li>
                        <li class="<?php if ($active == 'beranda') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('admin') ?>"><i class="fas fa-home fa-fw"></i> <span>Beranda</span></a></li>
                        <li class="nav-item dropdown <?php if ($active == 'jurusan') {
                                                            echo 'active';
                                                        } ?>">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Data Master</span></a>
                            <ul class="dropdown-menu">
                                <li class="<?php if ($active == 'jurusan') {
                                                echo 'active';
                                            } ?>"><a class="nav-link" href="<?= base_url('jurusan') ?>">Master Jurusan</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown <?php if ($active == 'pendaftar') {
                                                            echo 'active';
                                                        }
                                                        if ($active == 'smk') {
                                                            echo 'active';
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="<?php if ($active == 'smk') {
                                                echo 'active';
                                            } ?>"><a class="nav-link" href="<?= base_url('pendaftar/smk') ?>">Data SMK</a></li>
                                <li class="<?php if ($active == 'sma') {
                                                echo 'active';
                                            } ?>"><a class="nav-link" href="<?= base_url('pendaftar/sma') ?>">Data SMA</a></li>
                                <li class="<?php if ($active == 'pendaftar') {
                                                echo 'active';
                                            } ?>"><a class="nav-link" href="<?= base_url('pendaftar') ?>">Semua Data</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown <?php if ($active == 'formulir' || $active == 'daftarUlang') {
                                                            echo 'active';
                                                        } ?>">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-dollar-sign"></i><span>Verifikasi Pembayaran</span></a>
                            <ul class="dropdown-menu">
                                <li class="<?php if ($active == 'formulir') {
                                                echo 'active';
                                            } ?>"><a class="nav-link" href="<?= base_url('formulir') ?>">
                                        Formulir <span class="badge badge-primary" style="margin-left: 80px;"></span>
                                    </a></li>

                                <li class="<?php if ($active == 'daftarUlang') {
                                                echo 'active';
                                            } ?>"><a class="nav-link" href="<?= base_url('DaftarUlang') ?>">Daftar Ulang</a></li>
                            </ul>
                        </li>
                        <li class="<?php if ($active == 'tes') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('tes') ?>"><i class="fas fa-user-edit"></i> <span>Tes Potensi Akademik</span></a></li>
                        <li class="<?php if ($active == 'pengumuman') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('pengumuman') ?>"><i class="fas fa-bullhorn fa-fw"></i> <span>Pengumuman</span></a></li>
                        <li class="<?php if ($active == 'laporan') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('laporan') ?>"><i class="fas fa-chart-pie fa-fw"></i> <span>Laporan</span></a></li>
                        <li class="menu-header">Pengaturan</li>
                        <li class="<?php if ($active == 'user') {
                                        echo 'active';
                                    } ?>"><a class="nav-link" href="<?= base_url('user') ?>"><i class="fas fa-users-cog    "></i> <span>Manajemen User</span></a></li>
